...
export class WebBluetoothTransport implements QcyTransport {
  ...
  async connect(id: string, events: TransportEvents): Promise<void> {
    ...
    const service = await server.getPrimaryService("0000a001-0000-1000-8000-00805f9b34fb");
    this.writeChar = await service.getCharacteristic("00001001-0000-1000-8000-00805f9b34fb");
    const notify = await service.getCharacteristic("00001002-0000-1000-8000-00805f9b34fb");
